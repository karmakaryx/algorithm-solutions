...
<a name="PID1629"></a>
- **[PID1629] 곱셈:**<br>
분할정복 문제라 지수법칙을 이용했고 코드는 재귀함수를 이용하여 문제를 해결했습니다.<br>
먼저 지수가 최소가 될 때까지 셀프로 돌립니다. (마치 loss 함수 같네여..)<br>
그래도 남은 나머지들의 곱이 C보다 클 수 있으므로 끝까지 C로 나눠주면 최종 나머지가 나옵니다.<br>

<a name="PID11509"></a>
- **[PID11509] 풍선 맞추기:**<br>
이건 언어영역 문제네요. 문제 해석 자체가 힘든..😑<br>
좌뇌형들은 국어 진짜 못하는 듯. 양손잡이라 다행이네여 한글의 반은 이해했다..

<a name="PID14425"></a>
- **[PID14425] 문자열 집합:**<br>
문제에서 이미 집합이라고 힌트를 줍니다ㅎㅎ 파이썬 리스트는 줘도 안 써요 느려터져 가지고..

<a name="PID9012"></a>
- **[PID9012] 괄호:**<br>
(아직은) 자료구조가 파이썬 문제보다 더 쉬워서 안도. (학부 시절 자료구조 알고리즘에 트라우마 있는 1인)

<a name="PID1655"></a>
- **[PID1655] 가운데를 말해요:**<br>
이번엔 힙한 힙이군요.<br>
이 문제는 도큐먼트 컨닝 좀 했음. 모르는 파이썬 함수다ㅠ

<a name="PID5430"></a>
- **[PID5430] AC:**<br>
이 문제 함정 많네요. 오류나고 결과랑 안 맞고 해서 디버깅 계속 했음.
점점 어려워진다..

<a name="PID11286"></a>
- **[PID11286] 절댓값 힙:**<br>
엊그제 나온 힙을 풀어봤으면 나름 쉽게 풀 수 있는 문제입니다.
